...
trigger IMP_ProjectActivity on Project_Activity__c (before insert, before update, before delete, after insert, after update, after delete, after undelete)
{
    ...
    if (Trigger.isBefore) 
    {
        ...
        if(Trigger.isInsert && ALL_CheckRecursive.runCodeBlockOnce('Project_Activity__c_beforeInsert'))
        {
            /* 
             * -----------------------------------------------------------------------
        ...
        else if(Trigger.isUpdate && ALL_CheckRecursive.runCodeBlockOnce('Project_Activity__c_beforeUpdate'))
        {
        ...
        else if(Trigger.isDelete && ALL_CheckRecursive.runCodeBlockOnce('Project_Activity__c_beforeDelete'))
        {
    ...
    else if (Trigger.isAfter) 
    {
        ...
        */
        ...
        if(Trigger.isInsert && ALL_CheckRecursive.runCodeBlockOnce('Project_Activity__c_afterInsert'))
        {
        ...
        else if(Trigger.isUpdate && ALL_CheckRecursive.runCodeBlockOnce('Project_Activity__c_afterUpdate'))
        {
        ...
        else if(Trigger.isDelete && ALL_CheckRecursive.runCodeBlockOnce('Project_Activity__c_afterDelete'))
        {            
