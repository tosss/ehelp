...
trigger IMP_ProjectTask on Project_Task__c (before insert, before update, before delete, after insert, after update, after delete, after undelete) 
{
    if (Trigger.isBefore) 
    {
        ...
        if(Trigger.isInsert && ALL_CheckRecursive.runCodeBlockOnce('Project_Task__c_beforeInsert') )
        {
            /*
            //Removed
        ...
        else if(Trigger.isUpdate && ALL_CheckRecursive.runCodeBlockOnce('Project_Task__c_beforeUpdate'))
        {
            /*
            //Removed
            if (!currentUserIsExcludedFromRules) 
        ...
        else if(Trigger.isDelete  && ALL_CheckRecursive.runCodeBlockOnce('Project_Task__c_beforeDelete'))
        {
    ...
    else if (Trigger.isAfter) 
    {
        ...
        */
        ...
        if(Trigger.isInsert && ALL_CheckRecursive.runCodeBlockOnce('Project_Task__c_afterInsert'))
        {
        ...
        */
        ...
        else if(Trigger.isUpdate && ALL_CheckRecursive.runCodeBlockOnce('Project_Task__c_afterUpdate'))
        {
            ...
            for(Project_Task__c newPrjTask : Trigger.New)
            {
                ...
                if((newPrjTask.Expected_Time_Spent__c != oldPrjTask.Expected_Time_Spent__c) ||
                   ...
                   (newPrjTask.CDK_Assignee__c != oldPrjTask.CDK_Assignee__c)
                   && newPrjTask.Status__c != 'Assigned')
                {
                ...
                if(newPrjTask.CDK_Assignee__c != oldPrjTask.CDK_Assignee__c) {
                    activityIdSet.add(newPrjTask.Project_Activity__c);
                }
            }
            /*
            if(activityRollupsList  != null && !activityRollupsList.isEmpty())
        ...
        else if(Trigger.isDelete && ALL_CheckRecursive.runCodeBlockOnce('Project_Task__c_afterDelete'))
        {
