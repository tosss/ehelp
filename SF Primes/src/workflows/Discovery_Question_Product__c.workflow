...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <rules>
        <fullName>IMP_DiscoveryQuestionProduct_Set_Migration_ID</fullName>
        <actions>
            <name>IMP_DiscQuestProduct_Set_Migration_ID</name>
