...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <fieldUpdates>
        <fullName>AMAAPStrategyOptimization_Set_Migration</fullName>
        <field>Migration_ID__c</field>
        <formula>LEFT(Name, 95) + &apos;:&apos; + $Setup.CustomSettings__c.SF_Instance_Identifier__c</formula>
        <name>AMAAPStrategyOptimization_Set_Migration_</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <rules>
        <fullName>AMAAPStrategyOptimization_Set_Migration_ID</fullName>
        <actions>
            <name>AMAAPStrategyOptimization_Set_Migration</name>
