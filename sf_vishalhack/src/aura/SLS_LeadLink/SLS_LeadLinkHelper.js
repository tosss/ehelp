...
({
    ...
    matchSelectedAccountRecord: function(component, event, helper)
    {
        ...
        action.setCallback(this, function(response)
        {
            ...
            if(component.isValid() && state==="SUCCESS")
            {
                ...
                //2016-05-27- anirudh.singh@cdk.com- Added the below ELSE IF Block.
                else if(response.getReturnValue().indexOf('A Contact to the selected Account already exists')>=0)
                {
                    component.set("v.errorMessageValue", response.getReturnValue());
                    helper.hideSpinner(component, event, helper);
                    helper.showErrorMessage(component, event, helper);
    ...
    matchSelectedContactRecord: function(component, event, helper)
    {
        ...
        //2016-05-26- anirudh.singh@cdk.com- Added the below parameter to be passed to the controller method.
        var accountRecordId=component.get("v.leadAndLeadMatchesRecord.leadRecord.Current_Account__c");
        
        //2016-05-26- anirudh.singh@cdk.com- Added the accountRecordId parameter to be passed to the controller method.
        action.setParams({
